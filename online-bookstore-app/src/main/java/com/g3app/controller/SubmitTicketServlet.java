...
public class SubmitTicketServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Create new support ticket object using the constructor
            SupportTicket ticket = new SupportTicket(
                0,  // Assuming ticketId will be generated by the database
                customer_name,
                email,
                subject_title,
                type_of_enquiry,
                issue_description,
                "Open",  // Default status is 'Open'
                new Date()  // Set the current date as the submission date
            );
